...
const BUCKET = "rib-screenshots";

export default function RibScreenshotUpload({
  path,
  onChange,
}: {
  path: string | null;
  ...
  return (
    <div>
      <span className="mb-1 block text-sm font-medium text-neutral-700">Capture d&apos;écran du RIB</span>
      {path ? (
